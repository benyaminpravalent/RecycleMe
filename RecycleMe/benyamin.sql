...
-- Database: `benyamin`
--
CREATE DATABASE IF NOT EXISTS `benyamin` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `benyamin`;
...
-- Database: `datapesan`
--
CREATE DATABASE IF NOT EXISTS `datapesan` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `datapesan`;
...
(1, 'robertkwan.rk@gmail.com', 'admin'),
(2, 'admin', 'admin');
...
('root', '[{\"db\":\"benyamin\",\"table\":\"userdata\"},{\"db\":\"benyamin\",\"table\":\"users\"},{\"db\":\"benyamin\",\"table\":\"data\"},{\"db\":\"datapesan\",\"table\":\"user\"},{\"db\":\"test\",\"table\":\"mahasiswa\"},{\"db\":\"test\",\"table\":\"user\"},{\"db\":\"sbp\",\"table\":\"gejala\"},{\"db\":\"sbp\",\"table\":\"penyakit\"},{\"db\":\"sbp\",\"table\":\"basispengetahuan\"}]');
...
('root', '2019-06-29 15:28:17', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `sbp`
--
CREATE DATABASE IF NOT EXISTS `sbp` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sbp`;
...
(1, 123123, 'Benyamin', 'A', 'Ilmu Komputer');
